...
module.exports = {
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-XJZLVDG0J4', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'vzuJ6WMhZGNUUY0Oq4YEPiidvvyElQpsMfZJ4U5bnGQ', // Remove the value or replace it with your own google site verification code
